...
function addRecipesToDocument(recipes) {
  ...
  for (let i = 0; i < recipes.length; i++) {
    let currRecipes = document.createElement("recipe-card");
    currRecipes.data = recipes[i];
    main.append(currRecipes);
  }
}
...
function initFormHandler() {
  ...
  document.querySelectorAll('button')[0].addEventListener('click', (event)=>{
    ...
    let newRecipes = document.createElement("recipe-card");
    newRecipes.data = recipeObject;
    main.append(newRecipes);
